#' @title Definition of 'CellTalkTarget' class
#'
...
#' @import methods
#' @name CellTalkTarget
#' @rdname CellTalkTarget
#' @aliases CellTalkTarget-class
#' @exportClass CellTalkTarget

setClass("CellTalkTarget", representation(data = "list", meta = "data.frame", species = "character",
