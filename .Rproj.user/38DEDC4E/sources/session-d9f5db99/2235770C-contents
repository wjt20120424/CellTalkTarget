...
plot_CellTalkTarget_chord <- function(object, condition = NULL, celltype = NULL, celltype_color = NULL, miRNA = NULL, edge_color = NULL, edge_type = "big.arrow", show_type = "number", if_show_autocrine = FALSE, text_size = 1.5, y_scale = 0.1, ...) {
    # check input
...
plot_CellTalkTarget_circle <- function(object, condition = NULL, celltype = NULL, miRNA = NULL, celltype_color = NULL, edge_color = NULL, edge_type = "fan",
...
plot_CellTalkTarget_circle_simple <- function(object, condition = NULL, celltype, celltype_dir = "sender", miRNA = NULL, celltype_color = NULL, edge_color = NULL, edge_type = "fan",
    show_type = "number", if_show_autocrine = FALSE, edge_alpha = 0.5, node_size = 10, text_size = 5) {
    # check input
    if (!is(object, "CellTalkTarget")) {
      stop("Invalid class for object: must be 'CellTalkTarget'!")
...
plot_CellTalkTarget_sankey <- function(object, condition = NULL, celltype = NULL, miRNA = NULL, celltype_color = NULL, edge_color = NULL, show_type = "number", if_show_autocrine = FALSE,
...
plot_CellTalkTarget_heatmap <- function(object, condition = NULL, celltype = NULL, miRNA = NULL, show_type = "number", text_size = 10, viridis_option = "D", ...) {
    # check input
    if (!is(object, "CellTalkTarget")) {
        stop("Invalid class for object: must be 'CellTalkTarget'!")
    }
...
plot_miR_heatmap <- function(object, condition = NULL, celltype = NULL, miRNA = NULL, text_size = 10, if_horizontal = TRUE, viridis_option = "D", ...) {
    ...
    cci <- get_CellTalkTarget_cci(object)
    if (nrow(cci) == 0) {
        stop("No cci found in object!")
    }
    if (!is.null(condition)) {
...
plot_target_heatmap <- function(object, condition = NULL, celltype, targetgenes = NULL, limits = c(0,1), text_size = 10, if_horizontal = TRUE, viridis_option = "D", ...) {
    # get simple output
    cci_simple <- get_CellTalkTarget_cci(object)
